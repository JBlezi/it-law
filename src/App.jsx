    ...
    <Router>
      <div className="App dark:bg-grey">
        <div className='max'>
          ...
          {isSearching && (
            <div className="fixed inset-0 top-24 lg:top-32 xl:top-24 bg-white dark:bg-black bg-opacity-90 z-50 flex justify-center items-start overflow-y-auto" ref={searchResultsRef}>
